...
async def scrapper2(matches_league_path: str = None, position_table_league_path: str = None):    
    ...
    page_posiciones = urlopen(url_posiciones).read()
    soup_posiciones = BeautifulSoup(page_posiciones)
    
    tabla_pos = soup_posiciones.find("table")
    rows = tabla_pos.select('tr')
    ...
    #             # print(">>> este es la posición ::: ", texto_procesado)
